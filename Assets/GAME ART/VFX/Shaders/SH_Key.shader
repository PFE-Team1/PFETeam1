	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float4 Color = ( appendResult7 * step( ( 1.0 - ( tex2D( _TextureSample2, texCoord11 ).r + 0.0 ) ) , -( _Disolve_Key + appendResult50_g4.x ) ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;14;-1024,832;Inherit;False;Property;_Disolve_Key;Disolve_Key;1;0;Create;True;0;0;0;False;0;False;0.37;-2.38;-3;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;6;-640,-144;Inherit;True;Property;_sample_key;sample_key;0;0;Create;True;0;0;0;False;0;False;-1;None;787a871a12c1eec459bd7412b3e204ba;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5;16,-16;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=061816DBCA88BAD2248F5B4DBC5D25057376590B