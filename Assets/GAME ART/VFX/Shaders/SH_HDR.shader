	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float4 temp_cast_0 = (( tex2D( _MainTex, uv_MainTex ).a * _HDR )).xxxx;
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.RangedFloatNode;4;-768,240;Inherit;False;Property;_HDR;HDR;1;0;Create;True;0;0;0;False;0;False;0;6.54;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;5;-432,-32;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=F9DF4DE7DD88B65D3F79DA6A7E3FB1C166A2DD9A