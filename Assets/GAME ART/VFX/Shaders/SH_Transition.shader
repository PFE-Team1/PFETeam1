...
Shader "SH_TESTE_TRANSI"
{
	Properties
	{
		...
		_Float_GP("Float_GP", Range( 0 , 3)) = 2.543478
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag( VertexOutput IN  ) : SV_Target
			{
				...
				float2 texCoord110 = IN.texCoord0.xy * float2( 1,1 ) + float2( 0,0 );
				float smoothstepResult121 = smoothstep( 0.0 , 0.0 , ( _Float_GP - texCoord110.x ));
				float2 texCoord49 = IN.texCoord0.xy * _Tilling + float2( 0,0 );
				float4 tex2DNode51 = tex2D( _TextureCanvas, texCoord49 );
				float4 appendResult52 = (float4(tex2DNode51.rgb , tex2DNode51.r));
				
				float4 Color = ( smoothstepResult121 * appendResult52 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN) : SV_TARGET
			{
				...
				float smoothstepResult121 = smoothstep( 0.0 , 0.0 , ( _Float_GP - texCoord110.x ));
				float2 texCoord49 = IN.ase_texcoord.xy * _Tilling + float2( 0,0 );
				float4 tex2DNode51 = tex2D( _TextureCanvas, texCoord49 );
				float4 appendResult52 = (float4(tex2DNode51.rgb , tex2DNode51.r));
...
/*ASEBEGIN
Version=19801
Node;AmplifyShaderEditor.Vector2Node;109;-1040,-864;Inherit;False;Property;_Tilling;Tilling;1;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;49;-768,-816;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;57;-688,-592;Inherit;True;Property;_TextureCanvas;Texture Canvas;0;0;Create;True;0;0;0;False;0;False;6e52658e86b59bb4994e9d4e7632b30a;6e52658e86b59bb4994e9d4e7632b30a;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.TextureCoordinatesNode;110;-640,-384;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;122;-768,-192;Inherit;False;Property;_Float_GP;Float_GP;2;0;Create;True;0;0;0;False;0;False;2.543478;2.543478;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;113;-336,-384;Inherit;True;2;0;FLOAT;0.93;False;1;FLOAT;0.21;False;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;52;-48,-800;Inherit;True;COLOR;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SmoothstepOpNode;121;-80,-384;Inherit;True;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;118;240,-800;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
