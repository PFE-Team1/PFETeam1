...
public class StateRound : GameStateTemplate
{
    ...
    void AnimationDebutDeRound()
    {
        ...
        if (RoundManager.Instance.IsFirstRound())
        {
            mySequence.AppendCallback(() =>
            {
                PauseObject = GameObject.Instantiate(ManagerManager.Instance.ControlsPrefab);
        ...
        #endregion
        ManagerManager.Instance.PreRoundSequence = mySequence;
